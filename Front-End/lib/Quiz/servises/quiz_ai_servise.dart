...
2. **Concise Options:** Ensure that each answer option is concise, with a word count not exceeding 12 words also make sure not to not exceeding above 4 options, it means only having 4 options for each question except true/false questions.

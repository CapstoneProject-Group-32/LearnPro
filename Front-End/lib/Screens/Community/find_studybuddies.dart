...
//               _buildTab('People', 0, _tabController!.index),
//               _buildTab('Groups', 1, _tabController!.index),
//               _buildTab('Tutored You', 2, _tabController!.index),
//             ],
//           ),
//         ),
//         body: isLoading
...
// Widget _buildTab(String text, int tabIndex, int selectedIndex) {
//   return Tab(
//     child: Container(
//       padding: const EdgeInsets.symmetric(vertical: 8.0),
//       decoration: BoxDecoration(
